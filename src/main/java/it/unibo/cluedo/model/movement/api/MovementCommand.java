 ...
 * movements (e.g., single direction movement, combined direction movement). The {@code execute()} 
 * method is called to perform the movement.
 */
public interface MovementCommand {
     ...
     * it will perform the movement as defined by the specific command implementation.
     */
    void execute();
}
