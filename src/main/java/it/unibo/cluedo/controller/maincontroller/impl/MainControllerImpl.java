...
import it.unibo.cluedo.controller.maingameframecontroller.impl.MainGameFrameControllerImpl;
...
public class MainControllerImpl implements MainController {
    ...
    private final MainGameFrameController gameFrameController;
    ...
    public MainControllerImpl() {
        ...
        this.gameFrameController = new MainGameFrameControllerImpl();
        this.mainFrame = null;
        this.gameModel = null;
    }
     ...
     */
    @Override
    public MainGameFrameController getMainGameFrameController() {
